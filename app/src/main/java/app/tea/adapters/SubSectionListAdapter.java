 ...
 */
public class SubSectionListAdapter extends BaseAdapter{
    public ArrayList<HashMap<String,String>> list;
    Activity activity;
    TextView tv_sectionName;
    public SubSectionListAdapter(Activity activity, ArrayList<HashMap<String, String>> list) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = null;
        if(convertView == null){
            convertView=inflater.inflate(R.layout.adapter_addsection, null);
